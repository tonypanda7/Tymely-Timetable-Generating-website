...
const Sidebar = ({ currentView, onNavigate, role, collegeId, variant = 'dark', onLogout }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
          <path d="M21 15V5C21 3.89543 20.1046 3 19 3H5C3.89543 3 3 3.89543 3 5V15C3 16.1046 3.89543 17 5 17H17L21 21V15Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      ),
      visible: role === 'admin'
    },
